...
class Users implements UserInterface
{
     ...
     *     message="Password must be seven Characters long contain at least one digit, one upper case letter and one lower case letter",
     *     groups={"post"}
     * )
     */
    private $password;
